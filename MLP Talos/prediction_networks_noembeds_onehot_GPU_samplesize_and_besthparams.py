...
def main():
	...
	loaded_param=pd.read_csv("/projects/sysgen/users/jgrealey/embedding/src/src/pred_nets/final_talos_rounds/"+param_to_load)
	...
	results_dir="/projects/sysgen/users/jgrealey/embedding/hun_k_samples/results/pred_nets/"
	global plots_dir
	plots_dir="/projects/sysgen/users/jgrealey/embedding/hun_k_samples/plots/pred_nets/"
	embeds_dir="/projects/sysgen/users/jgrealey/embedding/hun_k_samples/results/dae/embedding_matrices/"
	#pheno_name=str(sys.argv[4])
	#embed_name=str(sys.argv[5])
	#model_name=str(sys.argv[6])#"dae_test_hiddenlay_model"
	...
	with open("/projects/sysgen/users/jgrealey/embedding/hun_k_samples/models/model_"+model_name+".json", "w") as json_file:
		json_file.write(model_json)
	print("model written")
	# serialize weights to HDF5
	model.save_weights("/projects/sysgen/users/jgrealey/embedding/hun_k_samples/models/model_"+model_name+".h5")
	
	print("Saved model to disk")
	print("model saved as\n","/projects/sysgen/users/jgrealey/embedding/hun_k_samples/models/model_{}".format(model_name))
